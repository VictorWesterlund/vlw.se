...
<section class="gpg">
	...
	<p>encrypt your message with my GPG code</p>
	<a href="https://api.vlw.se/gpg" target="_blank"><button class="solid">view key</button></a>
	<a href="https://api.vlw.se/gpg?download=true"><button>download as .txt</button></a>
</section>
<?= VV::media("line.svg") ?>
